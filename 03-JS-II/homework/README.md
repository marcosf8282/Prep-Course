...
* `for`: se utiliza para ejecturar un bucle. Haciendo cumplir la condicion indicada
* `&&`, `||`, `!`: && es como si esto y esto (=), || se usan para decir si esto o esto, ! es decir esto no es esto
